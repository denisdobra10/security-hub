				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							<div class="section-title">
								<h3 class="title">Do you have any question or suggestion?</h3>
							</div>
							<div class="form-group">
								<input class="input" type="text" id="name" placeholder="Full Name">
							</div>
							<div class="form-group">
								<input class="input" type="email" id="email" placeholder="email@gmail.com">
							</div>
							<div class="form-group">
						...
						<div class="order-notes">
							<textarea class="input" placeholder="Your message" id="message"></textarea>
						</div>
						<!-- /Order notes -->
                    <button class="primary-btn order-submit" onclick="ContactUs()">Send contact message</button>
