...
function AddToCart($userId, $productId) {
    ...
    if (mysqli_num_rows($result) > 0) {
      ...
      $query = "UPDATE cart SET products = '$productsJson' WHERE id = $cartId";
      ...
      $query = "INSERT INTO cart (user_id, products) VALUES ('$userId', '$productsJson')";
      mysqli_query($conn, $query);
    }
...
function EraseProductFromCart($userId, $productId) {
...
function EraseProductFromCarts($productId) {
...
function GetCartProductsJson($email)
{
    ...
    $stmt = $conn->prepare("SELECT products FROM cart WHERE user_id=?");
