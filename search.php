	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">These cameras might meet your requirements</h3>
					</div>
				</div>
				<!-- /row -->
			</div>
					...
					<div id="store" class="col-md-9">
						...
						<?php
							...
							if($products)
							{
								...
								{
									$oldPrice = floatval(number_format($product['price'], 2, '.', '')) * 1.2;
									...
									echo '
										...
										<div class="product">
											...
											<div class="product-body">
												...
												<h4 class="product-price">RON ' . $product['price'] . '</h4>
